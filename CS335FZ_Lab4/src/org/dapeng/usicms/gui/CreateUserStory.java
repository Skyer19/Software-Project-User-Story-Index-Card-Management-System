...
public class CreateUserStory extends JDialog {
	...
	public CreateUserStory() {
		...
		{// 这是create dialog 最north的一个panel
			...
			{// okay button 把信息写入us
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						us.setTimeStamp(date);
						us.setLastModified(date);
						// lab3, we get the time when we created it (time stamp).
						// notice: when we create it we need to set last modified time once
						us.addUserStory(us);
